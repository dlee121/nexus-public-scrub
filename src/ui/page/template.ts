...
<body>
  ...
  <section class="info-modal" id="run-modal" aria-live="polite" aria-hidden="true">
    <article class="info-card run-modal-card">
      <div class="info-head">
        <span id="run-modal-title">Run Output</span>
        <button class="settings-close" id="run-modal-close" type="button" aria-label="Close run output">×</button>
      </div>
      <div class="run-modal-body" id="run-modal-body">
        <pre class="run-modal-pre" id="run-modal-pre">Loading...</pre>
      </div>
    </article>
  </section>
  ...
  <main class="stage">
    ...
    <section class="hero">
      ...
      <section class="active-runs-section" id="active-runs-section">
        <div class="active-runs-head">
          <div class="active-runs-title">Active Runs</div>
          <div class="active-runs-sub">Tasks currently in progress</div>
        </div>
        <div class="active-runs-list" id="active-runs-list">
          <div class="active-runs-empty">No active runs.</div>
        </div>
      </section>
    </section>
    <section class="logs-pane" id="logs-pane">
      <div class="logs-head">
        <div>
          <div class="logs-title">Logs</div>
          <div class="logs-sub">Daemon and run output</div>
        </div>
        <div class="logs-actions">
          <button class="logs-refresh-btn" id="logs-refresh" type="button">Refresh</button>
          <button class="logs-toggle-btn" id="logs-toggle" type="button">Hide</button>
        </div>
      </div>
      <div class="logs-body" id="logs-body">
        <div class="logs-section">
          <div class="logs-section-title">Daemon</div>
          <pre class="logs-pre" id="logs-daemon">Loading...</pre>
        </div>
        <div class="logs-runs" id="logs-runs"></div>
      </div>
    </section>
    </div>
